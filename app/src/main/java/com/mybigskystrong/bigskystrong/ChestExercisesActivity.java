...
public class ChestExercisesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chestExercisesRecyclerAdapter = new ChestExercisesRecyclerAdapter(workoutSelected,selectedWorkoutTitle, getSupportFragmentManager(),sharedPreferences);
        exerciseRecyclerView.setAdapter(chestExercisesRecyclerAdapter);
    ...
    public void onBackPressed() {
        chestWorkoutsIntent = new Intent(getBaseContext(),ChestWorkoutActivity.class);
        startActivity(chestWorkoutsIntent);
    }
    ...
    public void deleteWorkout(){
        ...
        chestWorkoutsArrayList.remove(selectedWorkoutTitle);
        try{
            chestWorkoutsArrayListString = ObjectSerializer.serialize(chestWorkoutsArrayList);
        }catch(IOException e){
            Log.e("EEDF", e.toString());
        }
        sharedPreferences.edit().remove(workoutSelected).apply();
        sharedPreferences.edit().putString("ChestWorkoutSet", chestWorkoutsArrayListString).apply();
