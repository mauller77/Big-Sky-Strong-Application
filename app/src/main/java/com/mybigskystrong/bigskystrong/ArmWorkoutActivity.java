...
public class ArmWorkoutActivity extends AppCompatActivity {
    ...
    Intent armExerciseActivityIntent;
        ...
        customAdapter (Context context,JSONArray jsonArray){
            ...
            for (int i=0;i<jsonArray.length();i++){
                try{
                    ...
                    list.add(new singleRow(jsonObject.getString("Workout_Name"),jsonObject.getString("Exercise_1")));
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            workoutTitleButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    armExerciseActivityIntent = new Intent(getBaseContext(),ArmExerciseActivity.class);
                    ...
                    armExerciseActivityIntent.putExtras(b);
                    startActivity(armExerciseActivityIntent);
                }
            });
    ...
    class backgroundTask extends AsyncTask<Void,Void,JSONArray> {
        ...
        protected void onPostExecute(JSONArray resultArray) {
            workoutListView.setAdapter(new customAdapter(getBaseContext(),resultArray));
        }
