...
public class ArmExercisesRecyclerAdapter extends RecyclerView.Adapter<ArmExercisesRecyclerAdapter.ViewHolder> {
    public Button exerciseButton;
    SharedPreferences sharedPreferences;
    FragmentManager fragmentManager;
    ArrayList<String> armExercisesArrayList;
    ExerciseEditorDialogFragment editorDialogFragment;
    String workoutSelected;
    String selectedWorkoutTitle;


    public ArmExercisesRecyclerAdapter(String sW, String sWT, FragmentManager fm, SharedPreferences sharedPreferences1){
        ...
        try{
            armExercisesArrayList =  (ArrayList<String>) ObjectSerializer.deserialize(sharedPreferences.getString(workoutSelected,null));
        }catch(IOException e){
    ...
    @Override
    public ArmExercisesRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ArmExercisesRecyclerAdapter.ViewHolder holder, int position) {

        String exercise = armExercisesArrayList.get(position);
    ...
    public int getItemCount() {
        int size;
        if (armExercisesArrayList == null){
            size = 0;
        }else{
            size = armExercisesArrayList.size();
        }
        return size;
    }
