...
public class LegExerciseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LegExercisesIntent = getIntent();
        bundle = LegExercisesIntent.getExtras();
    ...
    class customAdapter extends BaseAdapter {
        ...
        ArrayList<LegExerciseActivity.singleRow> list;
        Context c;
        String jsonObjectWorkoutName;

        customAdapter (Context context,JSONArray jsonArray){
            c = context;
            list = new ArrayList<LegExerciseActivity.singleRow>();
                    ...
                    if (jsonObjectWorkoutName.equals(workoutName)){
                        for (int j = 1 ; j<=jsonObject.length(); j++){
                            ...
                            if (jsonObject.getString(exerciseName).equals("") ) {
                                ...
                                list.add(new LegExerciseActivity.singleRow(jsonObject.getString(exerciseName)));
                            }
                        }
                    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            LegExerciseActivity.singleRow tmp = list.get(position);
    ...
    public void getExercises(View view){
        new LegExerciseActivity.backgroundTask().execute();
    }
    ...
    class backgroundTask extends AsyncTask<Void,Void,JSONArray> {
        ...
        protected void onPostExecute(JSONArray resultArray) {
            exerciseListView.setAdapter(new LegExerciseActivity.customAdapter(getBaseContext(),resultArray));
        }
    ...
    public void onBackPressed() {
        LegActivityIntent = new Intent(this,LegWorkoutActivity.class);
        startActivity(LegActivityIntent);
    }
