...
public class ShoulderExerciseActivity extends AppCompatActivity {
    Intent ShoulderActivityIntent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ShoulderExercisesIntent = getIntent();
        bundle = ShoulderExercisesIntent.getExtras();
    ...
    class customAdapter extends BaseAdapter {
        ...
        ArrayList<ShoulderExerciseActivity.singleRow> list;
        Context c;
        String jsonObjectWorkoutName;

        customAdapter (Context context,JSONArray jsonArray){
            c = context;
            list = new ArrayList<ShoulderExerciseActivity.singleRow>();
                    ...
                    if (jsonObjectWorkoutName.equals(workoutName)){
                        for (int j = 1 ; j<=jsonObject.length(); j++){
                            ...
                            if (jsonObject.getString(exerciseName).equals("") ) {
                                ...
                                list.add(new ShoulderExerciseActivity.singleRow(jsonObject.getString(exerciseName)));
                            }
                        }
                    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ShoulderExerciseActivity.singleRow tmp = list.get(position);
    ...
    public void getExercises(View view){
        new ShoulderExerciseActivity.backgroundTask().execute();
    }
    ...
    class backgroundTask extends AsyncTask<Void,Void,JSONArray> {
        ...
        protected void onPostExecute(JSONArray resultArray) {
            exerciseListView.setAdapter(new ShoulderExerciseActivity.customAdapter(getBaseContext(),resultArray));
        }
    ...
    public void onBackPressed() {
        ShoulderActivityIntent = new Intent(this,ShoulderWorkoutActivity.class);
        startActivity(ShoulderActivityIntent);
    }
