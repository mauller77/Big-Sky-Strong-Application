...
public class ShoulderExercisesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shoulderExercisesRecyclerAdapter = new ShoulderExercisesRecyclerAdapter(workoutSelected,selectedWorkoutTitle, getSupportFragmentManager(),sharedPreferences);
        exerciseRecyclerView.setAdapter(shoulderExercisesRecyclerAdapter);
    ...
    public void onBackPressed() {
        shoulderWorkoutsIntent = new Intent(getBaseContext(),ShoulderWorkoutActivity.class);
        startActivity(shoulderWorkoutsIntent);
    }
    ...
    public void deleteWorkout(){
        ...
        shoulderWorkoutsArrayList.remove(selectedWorkoutTitle);
        try{
            shoulderWorkoutsArrayListString = ObjectSerializer.serialize(shoulderWorkoutsArrayList);
        }catch(IOException e){
            Log.e("EEDF", e.toString());
        }
        sharedPreferences.edit().remove(workoutSelected).apply();
        sharedPreferences.edit().putString("ShoulderWorkoutSet", shoulderWorkoutsArrayListString).apply();
